...
map("n", "<leader>lpp", "<cmd>Lspsaga show_line_diagnostics<CR>", { desc = "Line problems" })
map("n", "<leader>lpb", "<cmd>Lspsaga show_buf_diagnostics<CR>", { desc = "Buf problems" })
map("n", "<leader>lpw", "<cmd>Lspsaga show_workspace_diagnostics<CR>", { desc = "Workspace problems" })
