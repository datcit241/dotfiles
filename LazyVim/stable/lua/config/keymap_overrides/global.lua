return {
  ...
  toggle_options = {
    toggle_auto_format_buffer = "<leader>Tf",
    toggle_auto_format_global = "<leader>TF",
    toggle_spelling = "<leader>Ts",
    toggle_wrap = "<leader>Tw",
    toggle_relativenumber = "",
    toggle_diagnostics = "<leader>Td",
    toggle_number = "",
    toggle_conceallevel = "",
    toggle_treesitter = "<leader>TT",
    toggle_background = "",
    toggle_inlay_hints = "<leader>TH",
  },
  lazygit = {
    lazygit_toggle_root = "",
